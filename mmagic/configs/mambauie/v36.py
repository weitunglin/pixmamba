"""
defaultdict(<class 'float'>, {'conv': 0.09043968, 'layer_norm': 0.06684672, 'upsample_bilinear2d': 0.001572864, 'linear': 1.586270208, 'einsum': 0.18877, 'PythonOp.SelectiveScanFn': 0.2705264})
params 583683 GFLOPs 2.204425872
"""
...
optim_wrapper = dict(
    dict(
        ...
        optimizer=dict(type='AdamW', lr=0.0008, betas=(0.9, 0.999), weight_decay=0.5)))
