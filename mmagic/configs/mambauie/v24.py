"""
defaultdict(<class 'float'>, {'conv': 0.2820096, 'layer_norm': 0.41472, 'linear': 1.534470912, 'einsum': 0.53076, 'PythonOp.SelectiveScanFn': 0.7631064})
params 48198 GFLOPs 3.5250669119999998
"""
...
param_scheduler = [
    ...
    dict(type='MultiStepLR', by_epoch=True, milestones=[100,400,600,700,720], gamma=0.5)]
